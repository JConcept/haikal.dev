<nav class="navbar navbar-inverse sidebar" role="navigation" id="menu">
    <div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#">Menu<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-menu-hamburger"></span></a>
		</div>
			...
			<ul class="nav navbar-nav">
				...
				<li id="nav-galerie" class="dropdown">
					...
					<ul class="dropdown-menu forAnimate" role="menu">
						<li id="nav-photos"><a href="./photos.php"><span style="font-size:16px;" class="pull-left hidden-xs showopacity glyphicon glyphicon-picture"></span>Photos</a></li><!--camera-->
						<li class="divider"></li>
						<li id="nav-"><a href="./videos.php"><span style="font-size:16px;" class="pull-left hidden-xs showopacity glyphicon glyphicon-film"></span>Vidéos</a></li>
						<li class="divider"></li>
						<li id="nav-peintures"><a href="./peintures.php"><span style="font-size:16px;" class="pull-left hidden-xs showopacity glyphicon glyphicon-blackboard"></span>Peintures</a></li>
					</ul>
				</li>
